今天		12V藍芽		有跟阿傑上電測試 目前動作跟數據顯示還有連線狀況 都很不錯 但有些Issue 
		學姊家APP	APP debug好 有先送審核 但有發現歷史電壓累積數據看起來怪怪的

明天		12V藍芽		整理完 Issue list 再跟文傳回報
		學姊家APP	會再針對Server端 API 電壓累積的程式碼去修改
		15Kw		找時間驗機
