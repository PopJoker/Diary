今天		補獎Hirack	新Spec更新好了
		Hirack HMI	訂閱功能測試成功 今天也有測試Cell 平衡跟Pack補電的命令也有測試 都有成功 現在了解操作後正在進行平衡設置的工程頁面設計
					有利用訂閱訊息發送訊息 有辦法利用電腦發送MQTT訊息對Rack發送平衡命令 巨集程式流程會再簡化 避免後續維護困難

明天		Hirack HMI	繼續測試訂閱功能 +cycle run 並測試Modbus去發送平衡命令
...
##		APP BLE配網 #給阿傑測試中 回復 不要所20sec 太多

##		BCU 打開 HMI 會先把他問爆 流程梳理一下 #沒發現原因 開啟並不會發送訊息
