今天		堆高機Flutter	放進Mac用模擬機可以跑 但要實體機器才可以測藍芽通訊 等明天小飛回來進行
					安卓看後續跟長官討論有沒有需要釋出 或者給誰使用
		Web ems翻譯	下午把套件導入 開始逐步翻譯 目前 登入註冊畫面 設備選擇畫面 家用儲能的即時儀表板頁面

明天		Web ems翻譯	明天繼續翻譯其他家用儲能頁 與高壓儲能的葉面
		15kW web	+最大電流控制
					最大市電充電電流
					MaxACchargingcurrent

					設置電池最大充電電流
					batterymaximumchargecurrent
...
\\gus01ad.com\\fs\\OAFS\\02\_部門資料區\\CA430\_模組開發部\\Project\\CT01\_詮祐 5kWh ESS\\2.EVT 應該好了
