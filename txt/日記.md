今天		Google 上架	GusBLE 在Google上架請求被駁回了 是為了符合他的Package名稱 改完後其他部分忘記跟著修改 導致APP會一直閃退 找到問題處理完後就重新申請了
		GusEMS 今天也送出提交 待回復

明天		Hirack HMI	GusEMS HiRack 設備管理頁面設計完 開始導入實際的功能與測試
					整理CT01相關文件 如果有相關不懂的地方會再詢問文傳和副理
...
附件\_ 試產問題清單, 填寫問題改善對策

待資料完整後進行EVT 結案Pre Meeting，謝謝

文件放置路徑:

\\gus01ad.com\\fs\\OAFS\\02\_部門資料區\\CA430\_模組開發部\\Project\\CT01\_詮祐 5kWh ESS\\2.EVT
...
## BCU 打開 HMI 會先把他問爆 流程梳理一下 #待副理檢查
